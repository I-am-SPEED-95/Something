...
def load_dwh():
    dwh_customer_site()
    dwh_customer_contact()
    dwh_order_method()
    dwh_return_reason()
    dwh_course()
    dwh_satisfaction_type()
    dwh_sales_branch()
    dwh_sales_representative()
    dwh_product()
    dwh_date()
    dwh_order_returns()
    dwh_training()
    dwh_satisfaction()
    dwh_product_forecast()
    dwh_inventory_level()
    dwh_sales_target()
